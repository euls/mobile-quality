        ...
        return (<div className={'App'}>
                <Row style={{paddingTop:'2rem'}}>
                    <Col span={12} style={{textAlign: 'right'}}>
                        <Avatar style={{width: '4rem', height: '4rem',float: "right"}} shape="square" size={'large'}
                                src={this.props.location.state.thumbUrl ? this.props.location.state.thumbUrl : ""}/>
                    </Col>
                    <Col span={12} style={{textAlign: 'left', fontSize: '1rem'}}>
                        <Row style={{marginTop: '0.5rem', paddingLeft: '1rem'}}>
                            <span style={{backgroundColor:'red',color:'white'}}>质检工程师:{this.props.location.state.user}</span>
                        </Row>
                        <Row style={{marginTop: '0.5rem',paddingLeft: '1rem'}}>
                ...
                <Card style={{marginTop: '2rem', width: '50rem', marginLeft: 'auto', marginRight: 'auto'}}
                    ...
                    <Row>
                        <Col span={22} style={{marginLeft: 'auto', marginRight: 'auto', textAlign: 'center'}}>
                            <h4 style={{marginBottom: 5, fontSize: '1.6em'}}>检测报告</h4>
                        </Col>
                        <Col span={2}>
                            <img alt="example" style={{width: '8rem', float: "right", zIndex: 999}} src={zhangUrl}/>
                        </Col>
                    </Row>
                    <DescriptionList style={{marginBottom: 12, textAlign: 'left'}} col={1}>
                    ...
                    <Card type="inner" bordered={true} style={{marginBottom: 20}}>
                        ...
                        <Divider style={{ margin: '0.2rem 0.2rem' }} />
                        <DescriptionList size="large" col={2}
                                         style={{width: '30rem', marginLeft: 'auto', marginRight: 'auto'}}>
                    ...
                    <Card type="inner" bordered={false}>
                        <DescriptionList size="large" style={{marginBottom: 24}} title="功能检测">
                    ...
                    <DescriptionList
                        style={{marginBottom: 12, width: '30rem', marginLeft: 'auto', marginRight: 'auto'}}>
